...
export default function Sidebar({ collapsed, setCollapsed }) {
  return (
    <div className={cn(
      ...
      "w-16" // Permanently collapsed
    )}>
      <div className="h-16 flex items-center justify-center border-b border-brand-border overflow-hidden">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 258.53 52.47" className="h-8 shrink-0">
          <defs>
          ...
          {/* Text paths hidden in collapsed view via overflow-hidden on container */}
          <g>
      ...
      <div className="flex-1 py-4 overflow-y-auto">
        <nav className="space-y-1 px-2">
          {/* navItems rendering commented out */}
          {/* {navItems.map((item) => (
            ...
          ))} */}
        </nav>
